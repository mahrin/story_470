...
//    echo $recepie_cuisine;
    ...
    $query = mysql_query("SELECT * from recepie where main_copy=1 AND catagory='appetizer' AND  cuisine='" . $_POST["recepie_cuisine"] . "'");
}
?>
        ...
        <div class="container">
            <section class="super_sub_content row">
                <div class="dividerHeading text-center">
                    <h4 style="text-transform: uppercase;"><span><?php echo  'Appetizer '.$recepie_cuisine; ?></span></h4>
                </div>
