...
INSERT INTO `guest_info` (`username`, `f_name`, `l_name`, `email`, `address`, `contact`, `guest_id`, `password`) VALUES
('mahrin', 'mahrin', 'tasfe', '', '', 0, 1, 1234),
('fahim', 'fahim', 'aaaaaaaaaaaa', 'nicegollu@yahoo.com', 'ddfff', 111111, 10, 2222),
('samia', 'samia', 'aa', 'mahnaj@gamil.com', 'aa', 111111, 11, 1234),
('admin', 'admin', 'aaaaaaaaaaaa', 'mahrintasfe01@gmail.com', 'aaaa', 111111, 12, 1111),
('marshia', 'marshia', 'marshia', 'gollubabu@yahoo.com', 'aaa', 11111, 13, 1111),
('tasfe', 'tasfe', 'aaa', 'mahnaj@gamil.com', 'aa', 11111, 14, 1111),
('anika', 'mahrin', 'a', 'gollubabu@yahoo.com', 'aass', 111111, 15, 1111);
...
CREATE TABLE IF NOT EXISTS `recepie` (
  ...
  `recepie_name` varchar(100) NOT NULL,
